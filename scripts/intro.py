...
def generate_introduction():
    """
    Tworzy plik 'introduction.md' z wprowadzeniem do projektu.
    """
    # Ścieżka do pliku
    file_path = os.path.join(os.getcwd(), "introduction.md")

    # Utworzenie brakujących folderów
...
A dataset of EEG recordings from: Alzheimer's disease, Frontotemporal dementia and Healthy subjects. OpenNeuro. [Dataset] doi: doi:10.18112/openneuro.ds004504.v1.0.8
    ...
    print("Plik 'introduction.md' został utworzony!")
